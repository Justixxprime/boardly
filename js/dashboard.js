/* ==========================================================================
   ...
   files, loaded right after this one - see js/dashboard-extras.js for
   the first batch (export, bulk import, undo/redo, board backgrounds,
   presentation mode, ambient background). This is an ongoing, gradual
   split, not a rewrite - everything still shares the same global scope,
   so nothing about how any feature behaves has changed, only where its
   code lives. Look there first if you can't find something that used
   to be in this file.
