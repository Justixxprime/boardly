...
// (sha256Hex is defined once, near the top of this file)
...
Deno.serve(async (request) => {
  ...
  if (await isRateLimited(admin, request, "client-portal-action", { limit: 60, seconds: 600 }, { value: token, limit: 300, seconds: 3600 })) {
